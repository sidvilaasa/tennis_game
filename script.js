...
var colors = ['rgb(0, 0, 0)', 'rgb(48, 81, 42)', 'rgb(42, 55, 81)', 'rgb(81, 42, 45)', 'rgb(68, 69, 33)'];
...
var Game = {
    initialize: function () {
        ...
        this.color = colors[this.round]; // Set initial color based on the first round
    ...
    update: function () {
        ...
        if (this.player.score === rounds[this.round]) {
            ...
            if (!rounds[this.round + 1]) {
                ...
                this.ball.speed += 1;
                this.round += 1;
                this.color = colors[this.round]; // Set color based on the current round
            }
        }
        ...
        draw: function () {
            ...
            // Set the fill style to the current round color
            this.context.fillStyle = this.color;
